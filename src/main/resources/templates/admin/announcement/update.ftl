<@admin.layout title="修改公告">
<form action="${basePath}/admin/announcement/update" method="post" id="annForm">
    <input type="hidden" name="id" value="${announcement.id}">
    <div class="form-group row">
        <label for="title" class="col-sm-2 col-form-label col-form-label-sm text-right">标题:</label>
        <div class="col-sm-8">
            <input type="text" name="title" class="form-control form-control-sm" id="title" value="${announcement
            .title}"
                   placeholder="填写标题">
        </div>
    </div>
